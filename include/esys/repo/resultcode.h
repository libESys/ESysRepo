...
public:
    ...
    DECLARE_RESULT_CODE(MANIFEST_IS_NULLPTR);
    DECLARE_RESULT_CODE(CONFIG_FOLDER_IS_NULLPTR);
    DECLARE_RESULT_CODE(GIT_IS_NULLPTR);
    DECLARE_RESULT_CODE(JOB_COUNT_NEGATIVE);
    DECLARE_RESULT_CODE(ERROR_VECTOR);
    ...
    DECLARE_RESULT_CODE(MANIFEST_ELEMENT_UNKNOWN);
    DECLARE_RESULT_CODE(MANIFEST_ATTRIBUTE_UNKNOWN);
    DECLARE_RESULT_CODE(MANIFEST_INCORRECT_ATTRIBUTE_VALUE);
    DECLARE_RESULT_CODE(MANIFEST_NO_DEFAULT_LOCATION);
    DECLARE_RESULT_CODE(MANIFEST_TYPE_UNKNOWN);
    DECLARE_RESULT_CODE(MANIFEST_KIND_UNKNOWN);
    DECLARE_RESULT_CODE(MANIFEST_FORMAT_UNKNOWN);
    ...
    DECLARE_RESULT_CODE(MANIFEST_REPO_UNKNOWN);
    DECLARE_RESULT_CODE(MANIFEST_FILE_EXT_UNKNOWN);
    DECLARE_RESULT_CODE(MANIFEST_FAILED_TO_DETECT);
    DECLARE_RESULT_CODE(MANIFEST_XML_DATA_NULLPTR);
    DECLARE_RESULT_CODE(MANIFEST_REPOSITORY_WITHOUT_LOCATION);
    DECLARE_RESULT_CODE(MANIFEST_FORMAT_NOT_SET);
    ...
    DECLARE_RESULT_CODE(GIT_RESET_TYPE_NOT_SET);
    DECLARE_RESULT_CODE(GIT_RESET_TYPE_UNKNOWN);
    DECLARE_RESULT_CODE(GIT_NO_BRANCH_FOUND);
    DECLARE_RESULT_CODE(GIT_REPO_NOT_OPEN);
    DECLARE_RESULT_CODE(GIT_FIND_REF_FAILED);
    DECLARE_RESULT_CODE(GIT_GET_HASH_FAILED);
    DECLARE_RESULT_CODE(GIT_NO_PARENT);
    ...
    DECLARE_RESULT_CODE(CMD_NO_ESYSREPO_FOLDER_FOUND);
    DECLARE_RESULT_CODE(CMD_CONFIG_FOLDER_NULLPTR);
    DECLARE_RESULT_CODE(CMD_GIT_IS_NULLPTR);
    DECLARE_RESULT_CODE(CMD_GIT_IS_NOT_OPENED);
    DECLARE_RESULT_CODE(CMD_GIT_OPEN_FAILED);
    DECLARE_RESULT_CODE(CMD_GIT_IS_DIRTY_FAILED);
    DECLARE_RESULT_CODE(CMD_GIT_FETCH_FAILED);
    DECLARE_RESULT_CODE(CMD_GIT_GET_HEAD_FAILED);
    DECLARE_RESULT_CODE(CMD_GIT_MORE_THAN_ONE_COMMIT);
    DECLARE_RESULT_CODE(CMD_WORKSPACE_PATH_IS_EMPTY);

    DECLARE_RESULT_CODE(CMDSYNC_ABORTED_FOUND_CHANGES);
    DECLARE_RESULT_CODE(CMDSYNC_GIT_CAN_NOT_BE_FAST_FORWARDED);

    DECLARE_RESULT_CODE(RUNTASKS_NO_TASK);
...
enum class ResultCodei
{
    ...
    MANIFEST_ELEMENT_UNKNOWN = -202,
    MANIFEST_ATTRIBUTE_UNKNOWN = -203,
    MANIFEST_INCORRECT_ATTRIBUTE_VALUE = -204,
    MANIFEST_NO_DEFAULT_LOCATION = -205,
    MANIFEST_TYPE_UNKNOWN = -206,
    MANIFEST_KIND_UNKNOWN = -207,
    ...
    MANIFEST_REPO_UNKNOWN = -215,
    MANIFEST_FILE_EXT_UNKNOWN = -216,
