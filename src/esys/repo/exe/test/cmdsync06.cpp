/*!
 * \file esys/repo/exe/test/cmdsync06.cpp
 * \brief
 *
 * \cond
 * __legal_b__
...
/*! \class CmdSync06 esys/repo/exe/test/cmdsync06.cpp "esys/repo/exe/test/cmdsync06.cpp"
 *  \brief
 */
ESYSTEST_AUTO_TEST_CASE(CmdSync06)
{
    ...
    m_fix_cmd_sync.get_cmd_sync().set_groups({"grp_a"});
    m_fix_cmd_sync.sync();
    ...
    m_fix_cmd_sync.get_cmd_sync().set_groups({"grp_b"});
    m_fix_cmd_sync.sync();

    m_fix_cmd_sync.test_repo_exists("src/commit_a");
    m_fix_cmd_sync.test_repo_exists("src/commit_b");
    m_fix_cmd_sync.test_repo_exists("src/test_a");
    m_fix_cmd_sync.test_repo_exists("src/test_a_b");
    m_fix_cmd_sync.test_repo_exists("src/test_b");

    m_fix_cmd_sync.get_cmd_sync().set_groups({});
    m_fix_cmd_sync.sync({"."});
